...
<form name ="UpdateMgrForm" action="User/UserUpdateMgrTestP.jsp" method="post">
...
<div class = "adminlist">
	...
	<div align="center" >
		<table border = "1" align="center" style="width:600;" >
			...
			<tr height="40" align="center">  <!--  예외처리 테스트용으로 변경 (입력 유효성 생략 -->
				<td width="150"  style="background: #f6f5f0;">생년월일</td> <!-- 패턴 19940303 / 타이핑시 숫자 확인 / 이동(탭)시 입력숫자갯수 확인 -->
				<td width="350">	
					<input type="text" style="text-align:center" maxlength = "8" name="birth"value="<%=ezu1.getBirth() %>"  size="20" required/>  
				</td>		
			</tr>

			 <!-- 패턴 19940303 / 타이핑시 숫자 확인 / 이동(탭)시 입력숫자갯수 확인 : 입력값 정당성 모두 check  -->
			<!--  
			<tr height="40" align="center">
				<td width="150"  style="background: #f6f5f0;">생년월일</td>
				<td width="350">	
			...
			<tr height="40" align="center">
				...
				<td>
					<select name="city">
						...
						<option value="쿠알라룸프시">쿠알라룸프시</option>
					</select>
				</td>					
			</tr>

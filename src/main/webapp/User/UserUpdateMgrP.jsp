...
<%--	//errorPage  test용
	int t1 = 0;
	int t2 = 0;
	t1 = Integer.parseInt(request.getParameter("testnum1"));  
	t2 = Integer.parseInt(request.getParameter("testnum2"));  
...
<%--
	<h2>결과</h2> <br><br>
	<td> 덧셈 결과는 < %=t1 %> + < %=t2 %> = < %=sum %> 입니다.</td> <br><br>
	<td> 나눗셈 결과는 < %=t1 %> / < %=t2 %> = < %=div1 %> 입니다.</td>
--%>
